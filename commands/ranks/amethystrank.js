    ...
    try {
      ...
      const generateEmbedPage = async (startIndex) => {
        const embed = new EmbedBuilder()
          .setTitle("Classement des membres selon les <:amethyst:1261787385126060052>")
          .setColor("#FFD700")
        ...
        for (let index = 0; index < pageItems.length; index++) {
          ...
          try {
            ...
            let user = client.users.cache.get(userStats.userId);
            ...
            if (user) {
              embed.addFields({
                ...
                value: `*${userStats.coins}* <:amethyst:1261787385126060052>`,
                inline: inline,
              });
            } else {
              embed.addFields({
